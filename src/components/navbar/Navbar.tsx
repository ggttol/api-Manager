import { LayoutDashboard, Users, Network, Activity, BarChart3, Settings, Lock, BookOpen, Terminal } from 'lucide-react';
...
function Navbar() {
    ...
    const navItems: NavItem[] = [
        ...
        { path: '/codex', label: t('codex.title', 'Codex账号管理'), icon: Terminal, priority: 'medium' },
        { path: '/api-guide', label: t('nav.api_guide', 'API使用说明'), icon: BookOpen, priority: 'high' },
