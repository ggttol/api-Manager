import { LayoutDashboard, Users, Network, Activity, BarChart3, Settings, Lock, KeyRound, Terminal } from 'lucide-react';
...
function Navbar() {
    ...
    const navItems: NavItem[] = [
        ...
        { path: '/codex', label: t('codex.title', 'Codex'), icon: Terminal, priority: 'medium' },
